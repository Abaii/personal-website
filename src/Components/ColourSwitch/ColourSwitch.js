...
export const ColourSwitch = () => {
    ...
    const colors = {'lightMode': 'rgb(238, 226, 223)', 'darkMode': 'rgb(19, 51, 22)'};
    const changeColour = () => {
        color === colors.lightMode ? setColor(colors.darkMode) : setColor(colors.lightMode);
    ...
    return (
        <NavButton onClick={changeColour}>{colorLabel}</NavButton>
    )
};
